...
export const listContent = [
  {
    ...
    parag:
      "Over 50% of hiring managers prefer portfolios over traditional resumes.",
  },
  {
    title: "Showcase Your Unique Skills",
    parag:
      "A visually stunning portfolio doesn't just showcase your work—it tells your story.",
  },
  {
    title: "Stand Out and Succeed",
    parag:
      "First impressions count, and a portfolio makes yours unforgettable.",
  },
];
